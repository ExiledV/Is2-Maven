...
public class DisponibilidadCliente extends javax.swing.JFrame {
    ...
    public DisponibilidadCliente(Parcelas p) {
        this.parcelas = p;
        this.fechaIntroducida = new Date();
        initComponents();
        actualizaTabla();
    }

    public boolean estaOcupada(Date fecha, int fila, int col){
        return parcelas.hayReservas(fecha, fila, col);
    } 
        ...
        for(int i = 0; i <modelo.getRowCount(); i++)
            for(int j = 0; j < modelo.getColumnCount(); j++){
                ...
                if(!a)
                    ...
                    modelo.setValueAt("RESERVADA", i, j);
            }
    }
    ...
    private void initComponents() {
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(fechaChooser1, javax.swing.GroupLayout.PREFERRED_SIZE, 223, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(fechaChooser1, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void fechaChooser1OnSelectionChange(datechooser.events.SelectionChangedEvent evt) {//GEN-FIRST:event_fechaChooser1OnSelectionChange
        // TODO add your handling code here:
        fechaIntroducida = new Date(fechaChooser1.getSelectedDate().getTimeInMillis());
        actualizaTabla();
    ...
    //NOSE PORQUE ESTA EL FECHACHOOSER, EL QUE TIENE EL 1 ES EL GRANDE Y ES CON EL QUE FUNCIONA PERO NO HAY OTRO NO ENTIENDO
    ...
    void setMiMouseListener(MouseListener ml)
    {
